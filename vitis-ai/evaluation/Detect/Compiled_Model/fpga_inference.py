"""
FPGA/DPU only: run the compiled .xmodel and save int8 outputs to NPZ.

CPU evaluation (post_processing.py, coco_prep.py, evaluate.py) uses that NPZ in place of
running ONNX on the host for raw tensors.
"""
import cv2
import json
import numpy as np
